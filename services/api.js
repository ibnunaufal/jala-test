...
export const getKabar = (page, size) => {
  return new Promise((resolve, reject) => {
    axios
      .get(`${baseUrl}api/posts?per_page=${size}&page=${page}&with=creator`, {
        headers: {
          Authorization: `Bearer ${bearer}`,
          "access-control-allow-origin": "*",
        },
...
export const getPenyakit = (page, size) => {
  return new Promise((resolve, reject) => {
    axios
      .get(
        `${baseUrl}api/diseases?per_page=${size}&page=${page}&with=creator`,
        {
          headers: {
            Authorization: `Bearer ${bearer}`,
            "access-control-allow-origin": "*",
...
export const getExample2 = () => {
  return new Promise((resolve, reject) => {
    axios
      .get(
        "https://api.katalis.info/main_a/info/google-play/id.co.solusinegeri.katalisedc"
      )
      .then((res) => {
        resolve(res);
      })
...
export const getExample = () => {
  return new Promise((resolve, reject) => {
    fetch(`${baseUrl}api/shrimp_prices?per_page=10&page=1`, {
      method: "get",
      headers: {
        Authorization: `Bearer ${bearer}`,
        "access-control-allow-origin": "*",
